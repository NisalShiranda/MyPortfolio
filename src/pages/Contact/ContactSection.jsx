        ...
        <div className="contact pt-8 px-[50px] pb-8">
                ...
                <div className="grid grid-cols-1 pt-3 md:grid-cols-2  ">
                    <div className="flex flex-col justify-center items-center ">
                        ...
                        <p className="text-white text-[1.5rem] font-medium text-center  ">D.G Nisal Shiranda Ranasinghe</p>
                        <p className="text-[#F5D10D] text-[1rem] font-normal text-center pt-6 ">Home Address:</p>
                        <p className="text-white text-[1.5rem] font-medium text-center  ">No: 359/6, Damminnagahwatta, Kimbulapitiya</p>
                        <p className="text-[#F5D10D] text-[1rem] font-normal text-center pt-6  ">Mail Me:</p>
                        <p className="text-white text-[1.5rem] font-medium text-center  ">nisalshiranda001@gmail.com</p>
                        <p className="text-[#F5D10D] text-[1rem] font-normal text-center pt-6  ">Call Me:</p>
                        <p className="text-white text-[1.5rem] font-medium text-center  ">+94 711543730</p>
